    ...
    public Map<String, Object> getInverse() {
        ...
        for (final String term : terms) {
            ...
            if (Boolean.TRUE.equals(definition.get(JsonLdConsts.REVERSE))) {
                ...
                Map<String, Object> subtypesMap = (Map<String, Object>)typeMap.get(JsonLdConsts.REVERSE);
                if (subtypesMap == null) typeMap.put(JsonLdConsts.REVERSE, subtypesMap = new LinkedHashMap<String, Object>());

                if (definition.containsKey(JsonLdConsts.TYPE) && !isKeyword(definition.get(JsonLdConsts.TYPE)))
                    subtypesMap.put((String)definition.get(JsonLdConsts.TYPE), term);
                else
